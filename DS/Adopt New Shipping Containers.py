    ...
    for w in containerWidth:
        for h in containerHeigth:
            ...
            ContainerLine=[('ShipType', ['Container']),
                           ...
                           ('ContainerVolume',(format(round(containerVolume,6),
                                                      ".6f")))]
            if c==1:
...
print('################')
################################################################
sFileContainerName=Base + '/' + ContainerFileName
print(sFileContainerName)
    ...
    for w in boxWidth:
        for h in boxHeigth:
            for t in packThick:
                ...
                productVolume=round(((l-t)/boxStep)*((w-t)/boxStep)*((h-t)/
                                                                     boxStep),6)
                if productVolume > 0:
                    b=b+1
