...
def haversine(lon1, lat1, lon2, lat2,stype):
    """
    Calculate the great circle distance between two given GPS points
    on the surface the earth (specified in decimal degrees)
    """
...
WarehouseFrom=WarehouseGood.head(2)
